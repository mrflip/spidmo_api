  ...
  module Plugin
    ...
    class StatsdSender < EventMachine::Connection
      ...
      def initialize options={}
        @name   = options[:name] || File.basename(Goliath::Application.app_file, '.rb')
    ...
    #
    # @example
    #  plugin Goliath::Plugin::StatsdPlugin
    #
    # You might also enjoy using the Goliath::Rack::StatsdLogger middleware.
    #
    class StatsdPlugin
      attr_reader :agent
